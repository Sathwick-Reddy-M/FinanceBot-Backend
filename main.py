    ...
    with _account_setup_lock:
        ...
        for account in accounts:
            ...
            if account_type == "Investment":
                ...
                user_data.CHECKING_ACCOUNTS.append(CheckingOrSavingsAccount(**account))
            elif account_type == "Savings":
                user_data.SAVING_ACCOUNTS.append(CheckingOrSavingsAccount(**account))
        ...
        user_data.CREDIT_CARDS_DICT = {card.id: card for card in user_data.CREDIT_CARDS}
